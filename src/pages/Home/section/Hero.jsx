...
import { FileText, Award, Globe, Server, Edit3, CheckCircle } from 'lucide-react';
...
const Hero = () => {
  const features = [
    ...
    { icon: Edit3, text: 'Edit Any Document' },
    { icon: Award, text: 'PSD Files' }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight opacity-0 animate-fade-in-down">
            ...
            <div className="relative inline-block opacity-0 animate-slide-in-left delay-300">
              <div className="flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-teal-500/20 to-cyan-500/20 border border-teal-400/40 backdrop-blur-sm">
                ...
                <p className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-teal-300 via-cyan-300 to-teal-300 bg-clip-text text-transparent animate-gradient-shift">
          ...
          {/* Description */}
          <div className="max-w-3xl mx-auto space-y-4 opacity-0 animate-fade-in-up delay-500">
            <div className="space-y-2">
              <p className="text-base md:text-lg text-slate-400 font-medium">
                Utility Bills • Bank Statements • Licenses & More
              </p>
              <p className="text-sm md:text-base text-teal-400 font-semibold">
                Editable & Customizable • All Country Wise • VPS Available
              </p>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto pt-8">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {features.map((feature, index) => {
                ...
                const delayClass = `delay-${600 + (index * 100)}`;
                return (
                  <div
                    key={index}
                    className={`group relative opacity-0 animate-scale-in ${delayClass}`}
                  >
          ...
          {/* Trust Indicators */}
          <div className="pt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-slate-400 opacity-0 animate-fade-in-up delay-900">
